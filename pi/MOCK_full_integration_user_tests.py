...
from pi.valve import MockGPIO, MockValve #should be changed when we refactor it
...
print("OUTLOG NAME:" ,output_log_name)
...
valve1 = MockValve(VALVE_1_PIN, "A")
valve2 = MockValve(VALVE_2_PIN, "B")
valve3 = MockValve(VALVE_3_PIN, "C")
valve_dynamic = MockValve(VALVE_DYNAMIC_PIN, "Dynamic_valve")
valve_static = MockValve(VALVE_STATIC_PIN, "Static_valve")
valve_main = MockValve(VALVE_MAIN_PIN, "Main_valve")

# Pressure sensor initialization
pr_sensor_t1 = MPRLSFile("MOCK_full_run_csvs/T1_ALL_GOOD_tank_pressures.csv") #what should the channel be?
pr_sensor_t2 = MPRLSFile("MOCK_full_run_csvs/T1_ALL_GOOD_tank_pressures.csv")
pr_sensor_t3 = MPRLSFile("MOCK_full_run_csvs/T1_ALL_GOOD_tank_pressures.csv")
pr_sensor_canister = MockPressureSensorStatic(1.4)
pr_sensor_manifold = MPRLSFile("MOCK_full_run_csvs/T1_ALL_GOOD_tank_pressures.csv")
